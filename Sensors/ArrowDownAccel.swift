...
public class ArrowDownAccelDraw: NSObject{
    ...
    func drawCanvas1(frame: CGRect = CGRect(x: 0, y: 0, width: 113, height: 170), fraction: CGFloat = 0.916) {
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(rect: CGRect(x: 37.58, y: 21.75, width: 114, height: 27))
        appblue.setFill()
        rectanglePath.fill()
        ...
        bezierPath.move(to: CGPoint(x: 37.58, y: 21.75))
        bezierPath.addLine(to: CGPoint(x: 37.58, y: 0))
        bezierPath.addLine(to: CGPoint(x: 0, y: 32.86))
        bezierPath.addLine(to: CGPoint(x: 37.58, y: 68.14))
        appblue.setFill()
        bezierPath.fill()
